...
const Dashboard = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get(`${apiUrl}/dashboard/users`, {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(`${apiUrl}/dashboard/users/${editUser.id}`, editUser, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`${apiUrl}/dashboard/users/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
