...
const PlantReport = () => {
  ...
  const handleGetForm = async () => {
    ...
    try {
      const response = await axios.get(
        ...
        `${apiUrl}/plant-report/plants-with-last-report?zone=${plantZone}&number=${plantNumber}`,
        {
  ...
  const handleGetRecords = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${apiUrl}/plant-report/records?zone=${plantZone}&number=${plantNumber}&date=${formattedDate}`,
        {
          headers: { Authorization: `Bearer ${auth.token}` },
        }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${apiUrl}/plant-report`, reportData, {
        headers: { Authorization: `Bearer ${auth.token}` },
      });
  ...
  const handleSaveComment = async (id) => {
    ...
    try {
      await axios.patch(
        `${apiUrl}/plant-report/${id}/comment`,
